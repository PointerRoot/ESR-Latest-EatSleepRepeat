function ContestDetailsOpenFunction(id) {
    ...
    $.ajax({
        type: "GET",
        url: "http://admin.eatsleeprepeatesr.com/api/contests/GetAllContests?id=" + id + "", //URI
        dataType: "json",
            ...
            callback: function (result) {
                if (result) {
                    $("input:checkbox[name=checkboxDelete]:checked").each(function () {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: "http://admin.eatsleeprepeatesr.com/api/contests/DeleteContest?id=" + $(this).val() + "", //URI
                            dataType: "json",
                            contentType: "application/json",
...
function GetSingleContestByName() {
    ...
    $.ajax({
        type: "GET",
        url: "http://admin.eatsleeprepeatesr.com/api/contests/GetAllContestsByName?id=" + document.getElementById("ContestSearch").value + "", //URI
        dataType: "json",
        success: function (data) {
            debugger;
            var datavalue = data;
