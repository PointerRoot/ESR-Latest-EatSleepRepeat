function RestaurantUpdate(id) {
    ...
    $.ajax({
        type: "GET",
        url: "http://admin.eatsleeprepeatesr.com/api/tags/GetAllTags?id=" + count1 + "", //URI
        dataType: "json",
    ...
    $.ajax({
        type: "GET",
        url: "http://admin.eatsleeprepeatesr.com/api/deals/GetAllDeals?id=" + count3 + "", //URI
        dataType: "json",
        success: function (data) { 
            debugger;
            var datavalue = data;
    ...
    $.ajax({
        type: "GET",
        url: "http://admin.eatsleeprepeatesr.com/api/restaurants/GetAllRestaurantsById?id=" + id + "", //URI
        dataType: "json",
        success: function (data) {
            debugger;
            var datavalue = data;
...
function UpdateRestaurantForm() {
    ...
    if ($("#RestaurantName").val() != null) {
        ...
        var ajaxRequest = $.ajax({
            type: "POST",
            url: "http://admin.eatsleeprepeatesr.com/api/restaurants/UpdateRestaurant",
            ...
            success: function (data, textStatus, xhr) {
                if (data == 0) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "http://admin.eatsleeprepeatesr.com/api/restaurants/PostRestaurantTags?id=" + pack1 + "",
                        contentType: 'application/json; charset=utf-8',
                        processData: false,
                        dataType: "json",
                        data: RestaurantData,
                    ...
                    $.ajax({
                        type: "POST",
                        url: "http://admin.eatsleeprepeatesr.com/api/restaurants/PostRestaurantDeals?id=" + pack2 + "",
                        contentType: 'application/json; charset=utf-8',
                        processData: false,
                        dataType: "json",
                        data: RestaurantData,
