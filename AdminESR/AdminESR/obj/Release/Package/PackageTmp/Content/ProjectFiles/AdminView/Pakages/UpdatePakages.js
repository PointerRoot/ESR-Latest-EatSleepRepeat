 function PakageUpdate(id) {
    ...
    $.ajax({
        type: "GET",
        url: "http://admin.eatsleeprepeatesr.com/api/services/GetAllServices", //URI
        dataType: "json",
    ...
    $.ajax({
        type: "GET",
        url: "http://admin.eatsleeprepeatesr.com/api/pakages/GetAllPakagesById?id=" + id + "", //URI
        dataType: "json",
        success: function (data) {
            debugger;
            var datavalue = data;
...
function ValidatePakageForm() { 
    ...
    if ($("#Name").val() != null) { 
        ...
        var ajaxRequest = $.ajax({
            type: "POST",
            url: "http://admin.eatsleeprepeatesr.com/api/pakages/UpdatePakage",
            ...
            success: function (data, textStatus, xhr) {
                if (data == 0) {
                    ...
                    if (count1 != 0) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://admin.eatsleeprepeatesr.com/api/pakages/PostPakageServices?id=" + pack + "",
                            contentType: 'application/json; charset=utf-8',
                            processData: false,
                            dataType: "json",
                            data: PakageData,
