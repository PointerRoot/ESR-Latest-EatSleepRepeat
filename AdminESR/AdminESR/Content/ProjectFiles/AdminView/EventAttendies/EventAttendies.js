function StartFunction(id) {
    ...
    var script = "<script> var ajax = new XMLHttpRequest();" +
        " ajax.open('GET', 'http://localhost:6063/api/EventAttendies/GetAllApplicantsNames?Id=" + id + "', true);" +
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:6063/api/EventAttendies/GetAllAttendiesByEvent?id=" + id + "", //URI
        dataType: "json",
            ...
            callback: function (result) {
                if (result) {
                    $("input:checkbox[name=checkboxDelete]:checked").each(function () {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: "http://localhost:6063/api/EventAttendies/DeleteEventAttendies?id=" + $(this).val() + "", //URI
                            dataType: "json",
                            contentType: "application/json",
...
function GetSingleEventAttendiesByName() {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:6063/api/EventAttendies/GetAllAttendiesByName?id=" + document.getElementById("EventAttendiesSearch").value + "", //URI
        dataType: "json",
        success: function (data) {
            debugger;
            var datavalue = data;
