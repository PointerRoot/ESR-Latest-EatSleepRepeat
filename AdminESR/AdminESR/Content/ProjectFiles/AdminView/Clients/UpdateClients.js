function ClientUpdate(id) {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:6063/api/clients/GetAllClientsById?id=" + id + "", //URI
        dataType: "json",
        success: function (data) {
            debugger;
            var datavalue = data;
...
function UpdateClientForm() {
    ...
    if ($("#ClientName").val() != null) {
        ...
        var ajaxRequest = $.ajax({
            type: "POST",
            url: "http://localhost:6063/api/clients/UpdateClient",
            ...
            success: function (data, textStatus, xhr) {
                if (data == 0) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "http://localhost:6063/api/clients/PostClientPakage?id=" + pack + "",
                        contentType: 'application/json; charset=utf-8',
                        processData: false,
                        dataType: "json",
                        data: ClientData,
