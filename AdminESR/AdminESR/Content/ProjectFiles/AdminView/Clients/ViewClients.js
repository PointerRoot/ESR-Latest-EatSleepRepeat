function ClientDetailsOpenFunction(id) {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:6063/api/clients/GetAllClient?id=" + id +"", //URI
        dataType: "json",
...
function seePakages(id) {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:6063/api/clients/GetAllClientsPakageById?id=" + id + "", //URI
        dataType: "json",
        success: function (data) {
            debugger;
            var datavalue = data;
            ...
            callback: function (result) {
                if (result) {
                    $("input:checkbox[name=checkboxDelete]:checked").each(function () {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: "http://localhost:6063/api/clients/DeleteClient?id=" + $(this).val() + "", //URI
                            dataType: "json",
                            contentType: "application/json",
...
function GetSingleClientByName() {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:6063/api/clients/GetAllClientsByName?id=" + document.getElementById("ClientSearch").value + "", //URI
        dataType: "json",
        success: function (data) {
            debugger;
            var datavalue = data;
